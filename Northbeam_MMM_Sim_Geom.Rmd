...
fit150_getmtapriors <- stan(file='/Users/gregmurray/Documents/DS/Northbeam_MMM_sim_geom.stan',data=list(N=N, Y=Y_noise_mta_full, max_lag=max_lag, num_media=(2), num_media_inter=(2), num_media_full=(4), X_media=arr_mta_train), chains=4, iter=4000, warmup=1000,pars=c("noise_var","alpha","beta_medias_full", "x_bias_factors_adj", "k", "slope") )
